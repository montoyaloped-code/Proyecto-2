    ...
    <main className="container" style={{ padding: '4rem 1rem', minHeight: '80vh' }}>
      ...
      <div className="timeline" style={{ maxWidth: '800px', margin: '0 auto 4rem' }}>
        ...
        <article className="timeline-item">
          ...
          <div className="warning-box" style={{ background: 'rgba(201, 149, 43, 0.1)', borderLeft: '4px solid var(--accent)', padding: '1.25rem', borderRadius: '0 0.5rem 0.5rem 0', margin: '0.5rem 0' }}>
